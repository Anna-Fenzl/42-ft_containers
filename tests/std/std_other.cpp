...
void test_other()
{
	std::cout << std::boolalpha << std::endl;
	{
		...
		std::cout << std::lexicographical_compare(foo,foo+3,bar,bar+3) << std::endl;
		NEWLINE

		char foo0[] = "ab";
		std::cout << "Comparing foo (" << foo0 <<  ") and bar (" << bar << "):\t";
		std::cout << std::lexicographical_compare(foo0,foo0+2,bar,bar+3) << std::endl;
		NEWLINE

		char foo1[] = "aXc";
		std::cout << "Comparing foo (" << foo1 <<  ") and bar (" << bar << "):\t";
		std::cout << std::lexicographical_compare(foo1,foo1+3,bar,bar+3) << std::endl;
		NEWLINE
